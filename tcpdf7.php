...
<h4 style="text-align:center">HAPPY</h4>
<h5 style="text-align:center">NEWYEAR!</h5>
<h6 style="text-align:center">THANKYOU FOR BEING PART OF MY 2022</h6>
EOD;
$pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);

$pdf->Ln(10);

$pdf->Cell(0, 0, 'Love from Mark <3!', 1, 1, 'C', 0, '', 2);

$pdf->SetLineStyle($style6);

$pdf->StarPolygon(180, 230, 15, 20, 6, 0, 1, 'DF', array('all' => $style5), array(250, 220, 200), 'F', array(255, 200, 200));
$pdf->StarPolygon(100, 230, 15, 12, 5);
$pdf->StarPolygon(25, 230, 7, 12, 5, 45, 0, 'DF', array('all' => $style3), array(220, 220, 200), 'F', array(255, 200, 200));
